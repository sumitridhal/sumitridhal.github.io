...
export const writingMeta = {
  ...
  "coverSrc": "/writings/vector-matrix-spaces-for-fragment-shaders.png"
}
...
<figure className="writing-inline-figure">
  <img src="/writings/vector-matrix-spaces-for-fragment-shaders.png" alt={writingMeta.title} loading="lazy" decoding="async" />
</figure>

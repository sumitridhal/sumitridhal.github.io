...
export const writingMeta = {
  ...
  "coverSrc": "/writings/dots-and-halftone-in-fragments.png"
}
...
<figure className="writing-inline-figure">
  <img src="/writings/dots-and-halftone-in-fragments.png" alt={writingMeta.title} loading="lazy" decoding="async" />
</figure>
